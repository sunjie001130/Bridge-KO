...
# read in data
```{r}
big_25 <- read.csv("/ix/hpark/Jie/LMM/PCA_dist_combat2/big_samples_top_25%.csv")
big_50 <- read.csv("/ix/hpark/Jie/LMM/PCA_dist_combat2/big_samples_25_50%.csv")
big_75 <- read.csv("/ix/hpark/Jie/LMM/PCA_dist_combat2/big_samples_50_75%.csv")
big_100 <- read.csv("/ix/hpark/Jie/LMM/PCA_dist_combat2/big_samples_75_100%.csv")
...
```{r}
# check zero
zero_var_25 <- which(apply(big_25_scaled, 2, var) == 0) #0
...
write.csv(combined_equi_25, file = "~/knockoff_combat2/small_with_knockoffs_equi_25_pca.csv", row.names = FALSE) # Save to CSV
...
write.csv(combined_equi_50, file = "~/knockoff_combat2/small_with_knockoffs_equi_50_pca.csv", row.names = FALSE) # Save to CSV
...
write.csv(combined_equi_75, file = "~/knockoff_combat2/small_with_knockoffs_equi_75_pca.csv", row.names = FALSE) # Save to CSV
...
write.csv(combined_equi_100, file = "~/knockoff_combat2/small_with_knockoffs_equi_100_pca.csv", row.names = FALSE) # Save to CSV
```
...
write.csv(train_big_equi_25, "~/knockoff_combat2/train_big_equi_knockoffs_70_25_pca.csv", row.names = FALSE)
write.csv(test_big_equi_25,  "~/knockoff_combat2/test_big_equi_knockoffs_30_25_pca.csv",  row.names = FALSE)
write.csv(train_big_equi_50, "~/knockoff_combat2/train_big_equi_knockoffs_70_50_pca.csv", row.names = FALSE)
write.csv(test_big_equi_50,  "~/knockoff_combat2/test_big_equi_knockoffs_30_50_pca.csv",  row.names = FALSE)
write.csv(train_big_equi_75, "~/knockoff_combat2/train_big_equi_knockoffs_70_75_pca.csv", row.names = FALSE)
write.csv(test_big_equi_75,  "~/knockoff_combat2/test_big_equi_knockoffs_30_75_pca.csv",  row.names = FALSE)
write.csv(train_big_equi_100, "~/knockoff_combat2/train_big_equi_knockoffs_70_100_pca.csv", row.names = FALSE)
write.csv(test_big_equi_100,  "~/knockoff_combat2/test_big_equi_knockoffs_30_100_pca.csv",  row.names = FALSE)

write.csv(meta_train, "~/knockoff_combat2/meta_train_70_pca.csv", row.names = FALSE)
write.csv(meta_test,  "~/knockoff_combat2/meta_test_30_pca.csv",  row.names = FALSE)
```
...
# Save CSV for DNN input
write.csv(train_big_equi_25, "~/knockoff_combat2/train_big_equi_knockoffs_pitt_25_pca.csv", row.names = FALSE)
write.csv(test_big_equi_25,  "~/knockoff_combat2/test_big_equi_knockoffs_nonpitt_25_pca.csv",  row.names = FALSE)
write.csv(train_big_equi_50, "~/knockoff_combat2/train_big_equi_knockoffs_pitt_50_pca.csv", row.names = FALSE)
write.csv(test_big_equi_50,  "~/knockoff_combat2/test_big_equi_knockoffs_nonpitt_50_pca.csv",  row.names = FALSE)
write.csv(train_big_equi_75, "~/knockoff_combat2/train_big_equi_knockoffs_pitt_75_pca.csv", row.names = FALSE)
write.csv(test_big_equi_75,  "~/knockoff_combat2/test_big_equi_knockoffs_nonpitt_75_pca.csv",  row.names = FALSE)
write.csv(train_big_equi_100, "~/knockoff_combat2/train_big_equi_knockoffs_pitt_100_pca.csv", row.names = FALSE)
write.csv(test_big_equi_100,  "~/knockoff_combat2/test_big_equi_knockoffs_nonpitt_100_pca.csv",  row.names = FALSE)

write.csv(meta_train, "~/knockoff_combat2/meta_train_pitt_pca.csv", row.names = FALSE)
write.csv(meta_test,  "~/knockoff_combat2/meta_test_nonpitt_pca.csv",  row.names = FALSE)
```
